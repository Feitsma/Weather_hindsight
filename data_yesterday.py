...
wind_direction = df['DDVEC'].iloc[-1] #wind direction (360=north, 90=east, 180=south, 270=west, 0=calm/variable)

addDB.add_data_yesterday(yesterday, max_temp, min_temp, rain, Beaufort)
